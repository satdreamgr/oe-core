...
SRC_URI = "git://github.com/oe-mirrors/e2iplayer.git;branch=python3;protocol=https file://e2io.patch file://0001-Revert-distutils-are-outdated-use-setuptools.patch"
S = "${WORKDIR}/git"
